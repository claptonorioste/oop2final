...
public class Student {
	...
	public Student(int id, String lastName, String firstName, String middleName, String bday, String contactNo,
	...
	public String toString() {
		return "Student [id=" + id + ", lastName=" + lastName + ", firstName=" + firstName + ", middleName="
