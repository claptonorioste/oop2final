...
public class StudentController {
	...
	public String tryLogin(Login l) throws Exception {
		if(studentDbUtil.getAccount(l)==true) {
			return "menu?faces-redirect=true";	
		}else{
			return "error?faces-redirect=true";
		}
	}
	public String redirect(Login l) {
		System.out.println(l.getPage());
		if(l.getPage().equals("master")) {
			return "list-students?faces-redirect=true";	
		}else if (l.getPage().equals("client")){
